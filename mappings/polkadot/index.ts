...
import { Balances } from '../../chain/polkadot'

const SUBSTRATE_CHAIN = 'polkadot'
...
export async function balancesTransfer({
  ...
  fromAcc.substrateChain = SUBSTRATE_CHAIN
  ...
  toAcc.substrateChain = SUBSTRATE_CHAIN
  ...
  hbFrom.substrateChain = SUBSTRATE_CHAIN
  ...
  hbTo.substrateChain = SUBSTRATE_CHAIN
